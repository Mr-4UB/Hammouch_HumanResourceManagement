...
<div style="width: 858px; height: 92px" class="auto-style1">
    <label id="Label2"><span class="auto-style1">Box D'ajout<br />
				<button id="popup" class="auto-style5" name="Button1"
                        style="width: 847px" type="button" onclick="div_show('','','')">Ajouter
					Employe</button>
		</span><br /> </label>
</div>

<form:form action="fetchEmployees" class="auto-style2" method="get"
           style="height: 137px" modelAttribute="employeeSearchForm">
    <label id="Label1"><span class="auto-style1">Box De Recherche</span><br />
        <br /> <span class="auto-style4">Id Employe&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </label>
    <form:input name="searchEmployeeId" path="employeeId"
                style="width: 165px" type="text" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span class="auto-style4">Nom Employe</span>
    <form:input name="searchEmployeeName" path="employeeName" style="width: 165px" type="text" />
    <br />
    <br />
    <span class="auto-style4">Salaire Employe</span>&nbsp;
...
<div style="width: 858px; height: 545px" class="auto-style1">
    Resultats De Recherche(Clicker pour modifier)<br />
    <table style="width: 100%" border="solid">
        <tr>
            <th style="width: 253px" class="auto-style4">Id Employe</th>
            <th style="width: 301px" class="auto-style4">Nom Employe</th>
            <th class="auto-style4">Salaire Employe</th>
        </tr>
        <%--          <% for(int i = 0; i < 3; i+=1) { %>  --%>
